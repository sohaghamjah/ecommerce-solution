      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          @if (session()->get('language') == 'bangla')
            <ul class="list-unstyled">
              <li><a href="#"><i class="icon fa fa-user"></i>মাই একাওউন্ট</a></li>
              <li><a href="#"><i class="icon fa fa-heart"></i>উইশলিস্ট</a></li>
              <li><a href="#"><i class="icon fa fa-shopping-cart"></i>মাই কার্ট</a></li>
              <li><a href="#"><i class="icon fa fa-check"></i>চেকআওউট</a></li>
              @auth
              <li><a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>ডেশবোর্ড</a></li>
              @else
              <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>লগইন/রেজিস্টার</a></li>
              @endauth
            </ul>
          @else
          <ul class="list-unstyled">
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            @if (session()->get('language') == 'bangla')
              <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">ইউএসডি </span><b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">ইউএসডি</a></li>
                  <li><a href="#">আইএনআর</a></li>
                  <li><a href="#">জিবিপি</a></li>
                </ul>
              </li>
            @else
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            ...
            @endphp
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm mega-menu"> <a href="{{ url('/') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">@if (session()->get('language') == 'bangla') {{ $category->name_bn }}  @else {{ $category->name_en }}  @endif</a>
                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          {{-- Get category from database --}}
                          @php
                              $subcategories = DB::table('sub_categories')->where('category_id',$category->id)->orderBy('name_en','ASC')->get();
                          @endphp
