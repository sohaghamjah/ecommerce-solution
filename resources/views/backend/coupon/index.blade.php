        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">All Coupon</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form novalidate="" method="POST" action="{{ route('coupon.store') }}">
                            @csrf
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                Swal.fire(
                                    'Deleted!',
                                    'Coupon has been deleted successfull.',
                                    'success'
                                )
                                datatable_dt.draw();
                            }
